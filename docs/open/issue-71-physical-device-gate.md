...
Automated hardening is complete through Issue #150.

Final automated application baseline before this checklist:

- `main`: `4dce853225e5aa153e8ad3c68aac7cd86ae052e9`
...
Before a physical run, use the exact current production SHA recorded in GitHub Issue #71. Do not infer the tested SHA from an old screenshot or local checkout.
...
Install the final production build on at least one physical mobile platform; iOS is preferred.
...
| Target | Device | OS | Browser/PWA | Production SHA | Orientation | Scenario | Result | Notes / reproduction |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
- installed-PWA physical evidence is recorded;
- material defects are resolved/revalidated or separately tracked;
- the exact deployed SHA used for the final passes is recorded in Issue #71.
