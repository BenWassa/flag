...
**Status:** scoped behind the shared global expansion foundation; implement after at least one simpler continent has proven the generic onboarding path.
...
- zero-land-neighbour island states such as Iceland and Malta remain accurate empty sets and standard-round-ineligible.
