...
**Status:** CLOSED — superseded by the Issue #166 production cutover.

The sibling `./spatial/` deployment, its pinned-source assembly, its isolated
...
**Original status:** implementation contract for deployed physical-device evaluation
