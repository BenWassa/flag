...
assert.ok(serviceWorker.includes('flag-atlas-runtime-v1'), 'React/Vite rollout invalidates the previous app-shell cache.');
...
console.log('Routing verification passed: simplified launchers, canonical Africa routes, replace-only selection history, Play titles with stable /test routes, result navigation, and stable Atlas PWA shell.');
