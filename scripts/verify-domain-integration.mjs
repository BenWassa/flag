...
assert.ok(serviceWorker.includes("const VERSION = 'flag-atlas-v17'"), 'Issue #77 shell changes advance the PWA cache to v17.');
...
console.log('Cross-domain integration verification passed: mode-first Home, full-width continent and region selection, deliberate Africa launchers, v17 Atlas shell, cached map runtime, and deferred incomplete Neighbours targets.');
